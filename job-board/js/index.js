// let URLCHANGE =
//     'https://1r3pn5o9.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type+%3D%3D+%22vacancies%22+%26%26+approved%5D'
// fetch the content
async function fetchSanityApprovedJobs() {
    const response = await fetch(
        `https://1r3pn5o9.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type+%3D%3D+%27vacancies%27%5D+%0A%0A`
    )
...
fetchSanityApprovedJobs().then((approvedJobs) => {
