let URLTHREE =
    'https://1r3pn5o9.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type+%3D%3D+%27vacancies%27%5D+%7B%0A++description%2C%0A++++startDate%2C%0A++++duration%2C%0A++++companyName%2C%0A++++skills%2C%0A++++approved%2C%0A++++jobTitle%0A%7D%0A%0A'
// fetch the content
        ...
        if (result.length > 0) {
            ...
            result.forEach((result) => {
                if (result.approved == true) {
                    ...
                    vacanciesItemtitle.classList.add(
                    ...
                    let vacanciesAccordionCompanyName =
                        document.createElement('p')
                    vacanciesAccordionCompanyName.textContent =
                        result.companyName
                    vacanciesAccordionContentItem1.appendChild(
